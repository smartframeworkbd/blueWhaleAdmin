...
const Accept = () => {
  ...
  ?.filter(accept => accept?.grievanceStatus === "Accepted")
  ?.map((grievance, index) => ({
    key: index,
    id: grievance.Id,
  ...
  // const handleViewGrievance = (grievanceData) => {
  //   setSelectedGrievance(grievanceData);
  ...
  return (
    <>
     ...
     { currentLanguage == 'en' ? "View  all grievance " : "  গৃহীত অভিযোগ সমূহ দেখুন" } 
      </div>
      ...
      <EditModal isEditModalOpen={isEditModalOpen} 
       title={currentLanguage  == 'en' ? "Edit Grievance" : "অভিযোগের অবস্থা দেখুন"}>
